...
export type KChipNode = {
  icon?: Omit<KButtonIconProps, 'size' | 'tintColor'>;
  avatarUri?: string;
  onPress?: () => void;
};
...
export interface KCollapsibleView extends React.PropsWithChildren<CollapsibleProps>, TestModifier {}

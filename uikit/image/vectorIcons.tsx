...
import { KVectorIconsProps } from '../../types';
import { bcaFontSelection, droppiiFontSelection, KColors } from '../../constants';
import KContainer from '../container';

const Droppii = createIconSetFromIcoMoon(bcaFontSelection);
export const DroppiiNew = createIconSetFromIcoMoon(droppiiFontSelection);
